import cv2
cap = cv2.VideoCapture("Resource/surveillance.mp4")                                        #Input as Video
#object Detection
...
while True:
    ...
    mask = object_detector.apply(Region)

    #Creating mask on the Region of Interest
